...
public class PathFish implements FishConstants {
	...
	public ArrayList<Path> pathCaNho1() {
		...
		Path path1 = new Path(5)
				.to(-60, CAMERA_HEIGHT / 8)
				.to(-50, CAMERA_HEIGHT - CAMERA_HEIGHT / 8 + random.nextInt(20))
				...
				.to(-40, CAMERA_HEIGHT + random.nextInt(10));
		listPathCaNho1.add(path1);
		Path path2 = new Path(7)
				.to(-60, CAMERA_HEIGHT / 8)
				.to(-50, CAMERA_HEIGHT - 20 - random.nextInt(50))
				...
				.to(-50, 50 + random.nextInt(50));
		listPathCaNho1.add(path2);
		Path path3 = new Path(4)
				.to(-60, CAMERA_HEIGHT - CAMERA_HEIGHT / 8)
				.to(-50, CAMERA_HEIGHT - 30 - random.nextInt(50))
				.to(CAMERA_WIDTH / 4 + random.nextInt(20),
						CAMERA_HEIGHT - CAMERA_HEIGHT / 4 - random.nextInt(10))
				.to(CAMERA_WIDTH + 50, 50 + random.nextInt(50));
		listPathCaNho1.add(path3);
		Path path4 = new Path(6)
				.to(CAMERA_WIDTH + 60, 40 + random.nextInt(50))
				.to(CAMERA_WIDTH + 50, 40 + random.nextInt(50))
				...
				.to(-60, CAMERA_HEIGHT - random.nextInt(10));
		listPathCaNho1.add(path4);
		Path path5 = new Path(6)
				.to(CAMERA_WIDTH + 60, 50)
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2 - random.nextInt(50))
				...
				.to(-60, CAMERA_HEIGHT - 30 - random.nextInt(30));
		listPathCaNho1.add(path5);
		Path path6 = new Path(7)
				.to(-60, 20)
				.to(-60, 20 + random.nextInt(50))
				...
				.to(-60, 20 + random.nextInt(10));
		listPathCaNho1.add(path6);
		Path path7 = new Path(5).to(-60, 50)
				.to(-50, CAMERA_HEIGHT / 4 + random.nextInt(10))
				.to(CAMERA_WIDTH / 4 + random.nextInt(40), CAMERA_HEIGHT / 2)
				.to(CAMERA_WIDTH / 2 + random.nextInt(50), CAMERA_HEIGHT - 10)
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT - random.nextInt(10));
		listPathCaNho1.add(path7);
		Path path8 = new Path(3).to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2)
				.to(CAMERA_WIDTH + 40, CAMERA_HEIGHT / 2 + random.nextInt(5))
				.to(-60, CAMERA_HEIGHT / 2 + random.nextInt(10));
		listPathCaNho1.add(path8);
		Path path9 = new Path(3).to(-60, CAMERA_HEIGHT / 2)
				.to(-50, CAMERA_HEIGHT / 2 - random.nextInt(5))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2 - random.nextInt(5));
		listPathCaNho1.add(path9);
		Path path10 = new Path(3).to(-60, CAMERA_HEIGHT - random.nextInt(10))
				.to(-50, CAMERA_HEIGHT - random.nextInt(10))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT - random.nextInt(10));
		listPathCaNho1.add(path10);
		Path path11 = new Path(3)
				.to(CAMERA_WIDTH + 60, CAMERA_HEIGHT - random.nextInt(10))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT - random.nextInt(10))
				.to(-50, CAMERA_HEIGHT - random.nextInt(10));
		listPathCaNho1.add(path11);
		Path path12 = new Path(3).to(-60, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5));
		listPathCaNho1.add(path12);
		Path path13 = new Path(3).to(CAMERA_WIDTH + 60, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5));
	...
	public ArrayList<Path> pathCaNho2() {
		...
		Path path11 = new Path(13)
				...
				.to(CAMERA_WIDTH / +random.nextInt(20), 80 + random.nextInt(50))
				...
				.to(CAMERA_WIDTH + 60, CAMERA_HEIGHT / 2);
		...
		Path path1 = new Path(12)
				.to(CAMERA_WIDTH + 50, 20 + random.nextInt(10))
				.to(CAMERA_WIDTH + 40, 20 + random.nextInt(10))
				.to(40, 20 + random.nextInt(10))
		...
		Path path15 = new Path(3).to(-60, CAMERA_HEIGHT - random.nextInt(10))
				.to(-50, CAMERA_HEIGHT - random.nextInt(10))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT - random.nextInt(10));
		...
		Path path14 = new Path(3).to(-60, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5));
		listPathCaNho2.add(path14);
		Path path17 = new Path(3).to(CAMERA_WIDTH + 60, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5));
	...
	public ArrayList<Path> pathCaNho3() {
		...
		Path path3 = new Path(3).to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2)
				.to(CAMERA_WIDTH + 40, CAMERA_HEIGHT / 2 + random.nextInt(5))
				.to(-60, CAMERA_HEIGHT / 2 + random.nextInt(10));
		listPathCaNho3.add(path3);
		Path path4 = new Path(3).to(-60, CAMERA_HEIGHT / 2)
				.to(-50, CAMERA_HEIGHT / 2 - random.nextInt(5))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2 - random.nextInt(5));
		listPathCaNho3.add(path4);
		Path path8 = new Path(3).to(-60, CAMERA_HEIGHT - random.nextInt(10))
				.to(-50, CAMERA_HEIGHT - random.nextInt(10))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT - random.nextInt(10));
		...
		Path path6 = new Path(3).to(-60, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5));
		listPathCaNho3.add(path6);
		Path path5 = new Path(3).to(CAMERA_WIDTH + 60, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5));
	...
	public ArrayList<Path> pathCaNho4() {
		...
		Path path = new Path(3).to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2)
				.to(CAMERA_WIDTH + 40, CAMERA_HEIGHT / 2 + random.nextInt(5))
				.to(-60, CAMERA_HEIGHT / 2 + random.nextInt(10));
		listPathCaNho4.add(path);
		Path path1 = new Path(3).to(-60, CAMERA_HEIGHT / 2)
				.to(-50, CAMERA_HEIGHT / 2 - random.nextInt(5))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT / 2 - random.nextInt(5));
		listPathCaNho2.add(path1);
		Path path2 = new Path(3).to(-60, CAMERA_HEIGHT - random.nextInt(10))
				.to(-50, CAMERA_HEIGHT - random.nextInt(10))
				.to(CAMERA_WIDTH + 50, CAMERA_HEIGHT - random.nextInt(10));
		...
		Path path4 = new Path(3).to(-60, 10 + random.nextInt(5))
				.to(-50, 10 + random.nextInt(5))
				.to(CAMERA_WIDTH + 50, 10 + random.nextInt(5));
